export const DRINKS = [
  { id: 'swarley_coffee',   name: "Swarley's Coffee",                         category: 'coffee',   type: 'Lore', price: 20,  desc: 'Cheap caffeine fix',                              special: null },
  { id: 'tootsie_roll',     name: 'The Tootsie Roll',                         category: 'cocktail', type: 'Lore', price: 132,  desc: "Slutty Pumpkin's drink (Kahlua + Root Beer)",     special: null },
  { id: 'whalefail_ale',    name: 'Whalefail Ale',                            category: 'beer',     type: 'Lore', price: 225,  desc: "Barney's corporate fallback beer",                 special: null },
  ...
  { id: 'house_red',        name: 'House Red Wine',                           category: 'cocktail', type: 'Real', price: 165,  desc: 'Glass of cabernet sauvignon',                      special: null },
  { id: 'house_white',      name: 'House White Wine',                         category: 'cocktail', type: 'Real', price: 251, desc: 'Glass of chilled chardonnay',                      special: null },
  { id: 'moscow_mule',      name: 'Moscow Mule',                              category: 'cocktail', type: 'Real', price: 272,  desc: 'Vodka, ginger beer, lime in copper mug',           special: null },
  ...
  { id: 'old_fashioned',    name: 'Old Fashioned',                            category: 'cocktail', type: 'Real', price: 430,  desc: 'Premium muddled bourbon classic',                  special: null },
  ...
  { id: 'glen_mckenna',     name: 'Glen McKenna 35-Yr Scotch',                category: 'cocktail', type: 'Lore', price: 680,  desc: 'Ultra-premium top shelf luxury',                   special: 'glen_mckenna' },
...
export const FOOD = [
  ...
  { id: 'sandwich_lore',    name: "A 'Sandwich'",             category: 'food', type: 'Lore', price: 290,  desc: "Ted's euphemism — sets status to 🥪 for 10 min",   special: 'sandwich' },
  { id: 'onion_rings',      name: 'Onion Rings',              category: 'food', type: 'Real', price: 435,  desc: 'Golden beer-battered rings',                        special: null },
  ...
  { id: 'loaded_nachos',    name: 'Loaded Nachos',            category: 'food', type: 'Real', price:  99,  desc: 'Layered cheese, jalapenos, salsa',                  special: null },
...
export const ALL_ITEMS = [...DRINKS, ...FOOD];
